...
class TestClass16(unittest.TestCase):
    ...
    def test_case03(self):
        """
            É usado para verificar se o bloco de código gera a exceção mencionada em assertRaises(). 
            Se o código gerar a exceção, o teste será aprovado, caso contrário, ele falha.
        """
